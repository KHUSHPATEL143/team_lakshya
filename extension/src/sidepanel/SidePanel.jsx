    ...
    try {
      ...
      if (isFormFillRequest) {
        ...
        if (errorOccurred || typeof chrome === 'undefined' || !chrome.tabs) {
          ...
          responseText = `⚡ **Auto-fill complete!** I scanned the active webpage form elements and successfully filled out **${filledCount}** field(s) using your custom variables profile (such as \`rollNo = 108645\`).`;
        } else {
